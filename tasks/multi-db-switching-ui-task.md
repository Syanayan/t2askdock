...
- [x] **E-1 Quick Pick アイテムに「アンマウント」ボタンを追加**
...
- [x] **E-2 アクティブプロファイルをアンマウントしようとした場合の保護**
...
- [x] **F-1 `taskDock.createDatabase` コマンドを登録**
...
- [x] **F-2 `package.json` に `taskDock.createDatabase` を追加**

---

## グループ G: エラーコード対応・ステータスバー更新

- [x] **G-1 `toUserFacingMessage` に新しいエラーコードを追加**
