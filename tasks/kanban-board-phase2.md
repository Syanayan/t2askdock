...
- [ ] **L-1 executeCommand を BoardWebviewPanel に渡す**
...
- [ ] **L-2 カンバンボードの projectId を保持して card:create に渡す**
...
- [ ] **N-3 extension.ts の createTask コマンドで全フィールドを受け取る**
