...
export class TaskDetailWebviewPanel {
  ...
  private buildHtml(detail: TaskDetail, subtasks: SubtaskItem[], comments: ReadonlyArray<CommentRow>): string {
    ...
    <div class="layout detail-layout"><div class="main detail-main">
      ...
      <div class="header-actions"><button id="btn-edit" class="btn secondary view-only">Edit</button><button id="btn-save" class="btn edit-only">Save</button><button id="btn-cancel" class="btn secondary edit-only">Cancel</button><button id="btn-close-task" class="btn secondary view-only">Close Task</button><button id="btn-archive" class="btn secondary view-only">Archive</button><button id="btn-close" class="btn secondary">Dismiss</button></div></div></section>
